...
* **Repository**: [BRACU DSpace Link](https://dspace.bracu.ac.bd/items/fcb0c1f9-183f-4bd4-aba8-3f915c5e4c58)
* **Recommendation Citation**: 'Farheen, T. J. (2026). Knowledge distillation in split learning for heterogeneous clinical tabular data [Master's thesis, BRAC University]. BRAC University Institutional Repository.'
